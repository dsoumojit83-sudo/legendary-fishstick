...
// Switched to standard OpenAI to fix the 403 Forbidden error
...
module.exports = async function(req, res) {     
    ...
    try {         
        ...
        const systemPrompt = ` You are the AI Sales Agent for ZyroEditz. You are highly intelligent, friendly, and professional.  Talk to the user like a real human studio manager. Keep responses concise (under 4 sentences). DO NOT perform math, just read the exact numbers provided.  
...
- CONTACT: Call or WhatsApp us at +91 7602679995 (Mon-Fri, 9am-5pm) or Email us anytime at zyroeditz.official@gmail.com.
